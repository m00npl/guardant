...
const Services = () => {
    ...
    const getServiceIcon = (type) => {
        const icons = {
            ...
            tcp: lucide_react_1.Server,
            ping: lucide_react_1.Wifi,
            github: lucide_react_1.Github,
            'uptime-api': lucide_react_1.Activity,
            keyword: lucide_react_1.Search,
            heartbeat: lucide_react_1.Heart,
            port: lucide_react_1.Network,
        };
        return icons[type] || lucide_react_1.Globe;
    };
    ...
    return (<div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <react_router_dom_1.Link to="/services/create" className="btn-primary">
      ...
      {/* Empty State */}
      {watchers.length === 0 && (<div className="card p-12 text-center">
          <div className="mx-auto w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mb-6">
            <lucide_react_1.Eye className="h-12 w-12 text-gray-400"/>
          </div>
        ...
        <div className="card p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center mb-3">
            <div className="p-2 bg-purple-100 rounded-lg">
              <lucide_react_1.Github className="h-6 w-6 text-purple-600"/>
            </div>
        ...
        <div className="card p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center mb-3">
            <div className="p-2 bg-green-100 rounded-lg">
              <lucide_react_1.Wifi className="h-6 w-6 text-green-600"/>
            </div>
        ...
        <div className="card p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center mb-3">
            <div className="p-2 bg-orange-100 rounded-lg">
              <lucide_react_1.Network className="h-6 w-6 text-orange-600"/>
            </div>
      ...
      {watchers.length > 0 && (<div className="card">
          ...
          <div className="divide-y divide-gray-200">
            {watchers.map((watcher) => {
                ...
                return (<div key={watcher.id} className="px-6 py-4 hover:bg-gray-50">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className={`w-3 h-3 rounded-full ${watcher.lastStatus === 'up' ? 'bg-success-500' :
                      ...
                      {/* Actions */}
                      <div className="flex items-center space-x-2">
                        <react_router_dom_1.Link to={`/services/${watcher.id}/edit`} className="p-2 text-gray-400 hover:text-gray-600 transition-colors">
