...
const logger = (0, logger_1.createLogger)('deployment-api');
exports.deploymentApi = new hono_1.Hono();
// Generate secure deployment token
const DEPLOYMENT_SECRET = process.env.DEPLOYMENT_SECRET || crypto_1.default.randomBytes(32).toString('hex');
// IP whitelist
...
exports.deploymentApi.use('/*', async (c, next) => {
    ...
    try {
        ...
        // Verify JWT token
        const decoded = jsonwebtoken_1.default.verify(token, DEPLOYMENT_SECRET);
...
exports.deploymentApi.post('/token', async (c) => {
    ...
    const token = jsonwebtoken_1.default.sign({
        ...
        issuedAt: Date.now(),
    }, DEPLOYMENT_SECRET, { expiresIn: '24h' });
    return c.json({
        success: true,
        token,
        expiresIn: '24h',
...
exports.deploymentApi.get('/logs/:service', async (c) => {
...
// Restart a service
exports.deploymentApi.post('/restart/:service', async (c) => {
    const service = c.req.param('service');
    try {
...
exports.deploymentApi.post('/build/:service', async (c) => {
    const service = c.req.param('service');
    try {
...
exports.deploymentApi.post('/deploy', async (c) => {
    try {
...
// Get service status
exports.deploymentApi.get('/status', async (c) => {
    try {
...
exports.deploymentApi.post('/exec', async (c) => {
