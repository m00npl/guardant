...
exports.CorsManager = exports.CorsConfigs = exports.CorsViolationType = void 0;
exports.createCorsMiddleware = createCorsMiddleware;
exports.createCorsManager = createCorsManager;
const logger_1 = require("./logger");
var CorsViolationType;
(function (CorsViolationType) {
    CorsViolationType["INVALID_ORIGIN"] = "invalid_origin";
    CorsViolationType["DISALLOWED_METHOD"] = "disallowed_method";
    CorsViolationType["FORBIDDEN_HEADER"] = "forbidden_header";
    CorsViolationType["CREDENTIALS_MISMATCH"] = "credentials_mismatch";
    CorsViolationType["PRIVATE_NETWORK_VIOLATION"] = "private_network_violation";
    CorsViolationType["SUSPICIOUS_REQUEST"] = "suspicious_request";
})(CorsViolationType || (exports.CorsViolationType = CorsViolationType = {}));
...
exports.CorsConfigs = {
    ...
    ADMIN: {
        ...
        enablePreflight: true,
        allowPrivateNetwork: false,
        customValidator: (origin, request) => {
...
class CorsManager {
    constructor(serviceName, tracing) {
        ...
        this.violations = [];
        this.logger = (0, logger_1.createLogger)(`${serviceName}-cors`);
    ...
    validateOrigin(origin, config, context) {
    ...
    validateMethod(method, config, context) {
    ...
    validateHeaders(requestedHeaders, config, context) {
...
function createCorsMiddleware(corsManager, config) {
    return async (c, next) => {
        const origin = c.req.header('origin') || '';
        const method = c.req.method;
        const headers = Object.fromEntries(Object.entries(c.req.headers || {}).map(([k, v]) => [k.toLowerCase(), v]));
        const context = {
            origin,
            method,
            headers,
...
// Factory function
function createCorsManager(serviceName, tracing) {
