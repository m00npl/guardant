...
const external_service_client_1 = require("../../services/workers/src/clients/external-service-client");
const bun_test_1 = require("bun:test");
(0, bun_test_1.describe)('Workers -> External Services Contract', () => {
    let pactSetup;
    let externalClient;
    (0, bun_test_1.beforeAll)(async () => {
        ...
        externalClient = new external_service_client_1.ExternalServiceClient({
    ...
    (0, bun_test_1.test)('should perform health checks on external services', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction(pact_consumer_1.GuardAntInteractions.externalHealthCheck());
        // Act
        ...
        (0, bun_test_1.expect)(result.version).toBeString();
        (0, bun_test_1.expect)(result.uptime).toBeNumber();
        await pact.verify();
    });
    (0, bun_test_1.test)('should monitor HTTP endpoints with status code validation', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        ...
        // Assert
        (0, bun_test_1.expect)(result.statusCode).toBe(200);
        (0, bun_test_1.expect)(result.responseTime).toBeNumber();
        (0, bun_test_1.expect)(result.body).toHaveProperty('status');
        (0, bun_test_1.expect)(result.headers).toHaveProperty('content-type');
        await pact.verify();
    });
    (0, bun_test_1.test)('should perform TCP port connectivity checks', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction({
        ...
        // Assert
        (0, bun_test_1.expect)(result.connected).toBe(true);
        (0, bun_test_1.expect)(result.responseTime).toBeNumber();
        (0, bun_test_1.expect)(result.port).toBe(443);
        await pact.verify();
    });
    (0, bun_test_1.test)('should perform ping connectivity tests', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction({
        ...
        // Assert
        (0, bun_test_1.expect)(result.alive).toBe(true);
        (0, bun_test_1.expect)(result.time).toBeNumber();
        (0, bun_test_1.expect)(result.host).toBe('example.com');
        await pact.verify();
    });
    (0, bun_test_1.test)('should monitor API endpoints with custom validation', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction({
        ...
        // Assert
        (0, bun_test_1.expect)(result.statusCode).toBe(200);
        (0, bun_test_1.expect)(result.validation.passed).toBe(true);
        (0, bun_test_1.expect)(result.data).toHaveProperty('metrics');
        (0, bun_test_1.expect)(result.data.metrics).toHaveProperty('requests_per_second');
        await pact.verify();
    });
    (0, bun_test_1.test)('should handle external service errors gracefully', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction({
        ...
        // Assert
        (0, bun_test_1.expect)(result.statusCode).toBe(500);
        (0, bun_test_1.expect)(result.success).toBe(false);
        (0, bun_test_1.expect)(result.error).toBeString();
        (0, bun_test_1.expect)(result.errorDetails).toHaveProperty('message');
        await pact.verify();
    });
    (0, bun_test_1.test)('should monitor SSL certificate validity', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction({
        ...
        // Assert
        (0, bun_test_1.expect)(result.ssl.valid).toBe(true);
        (0, bun_test_1.expect)(result.ssl.daysUntilExpiry).toBeNumber();
        (0, bun_test_1.expect)(result.ssl.issuer).toBeString();
        (0, bun_test_1.expect)(result.ssl.protocol).toBe('TLSv1.3');
        await pact.verify();
    });
    (0, bun_test_1.test)('should monitor DNS resolution performance', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction({
        ...
        // Assert
        (0, bun_test_1.expect)(result.resolved).toBe(true);
        (0, bun_test_1.expect)(result.addresses).toBeArray();
        (0, bun_test_1.expect)(result.resolveTime).toBeNumber();
        (0, bun_test_1.expect)(result.ttl).toBeNumber();
        await pact.verify();
    });
    (0, bun_test_1.test)('should perform custom webhook monitoring', async () => {
        const pact = pactSetup.getPact('workers-to-external');
        await pact.addInteraction({
        ...
        // Assert
        (0, bun_test_1.expect)(result.statusCode).toBe(200);
        (0, bun_test_1.expect)(result.data.received).toBe(true);
        (0, bun_test_1.expect)(result.data.processed).toBe(true);
        (0, bun_test_1.expect)(result.responseTime).toBeNumber();
        await pact.verify();
    });
});
//# sourceMappingURL=workers-to-external.test.js.map