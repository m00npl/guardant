...
const Settings = () => {
    const { nest } = (0, authStore_1.useAuthStore)();
    return (<div className="space-y-8">
      ...
      <div className="card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" className="input w-full" value={nest?.name || ''} readOnly/>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input type="text" className="input flex-1 rounded-r-none" value={nest?.subdomain || ''} readOnly/>
          ...
          <div>
            ...
            <input type="email" className="input w-full" value={nest?.email || ''} readOnly/>
          </div>
          ...
          <div>
            ...
            <input type="text" className="input w-full font-mono text-sm" value={nest?.walletAddress || ''} readOnly/>
          </div>
        </div>
      </div>
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <lucide_react_1.Crown className="h-6 w-6 text-warning-500"/>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <div className="flex items-center mb-4">
            <lucide_react_1.Globe className="h-6 w-6 text-primary-600 mr-3"/>
            <h3 className="text-lg font-semibold text-gray-900">
              Status Page
            </h3>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <input type="checkbox" checked={nest?.settings.isPublic} readOnly className="toggle"/>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Custom Domain
              </label>
              <input type="text" className="input w-full" placeholder="status.yourcompany.com" value={nest?.settings.customDomain || ''} readOnly/>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6">
          <div className="flex items-center mb-4">
            <lucide_react_1.Shield className="h-6 w-6 text-success-600 mr-3"/>
            <h3 className="text-lg font-semibold text-gray-900">
              Security
            </h3>
          </div>
          <div className="space-y-4">
            <button className="btn-secondary w-full justify-start">
              <lucide_react_1.Key className="h-5 w-5 mr-2"/>
        ...
        <div className="card p-6">
          <div className="flex items-center mb-4">
            <lucide_react_1.Bell className="h-6 w-6 text-warning-600 mr-3"/>
            <h3 className="text-lg font-semibold text-gray-900">
              Notifications
            </h3>
          </div>
        ...
        <div className="card p-6">
          <div className="flex items-center mb-4">
            <lucide_react_1.Palette className="h-6 w-6 text-purple-600 mr-3"/>
            <h3 className="text-lg font-semibold text-gray-900">
              Appearance
            </h3>
          </div>
      ...
      <div className="card border-error-200 p-6">
        <div className="flex items-center mb-4">
          <div className="p-2 bg-error-100 rounded-lg mr-3">
            <lucide_react_1.Shield className="h-5 w-5 text-error-600"/>
          </div>
