...
const IncidentsList = ({ incidents }) => {
    if (incidents.length === 0) {
        ...
        <lucide_react_1.CheckCircle className="h-12 w-12 text-success-500 mx-auto mb-4"/>
    ...
    return (<div className="space-y-6">
      {Object.entries(groupedIncidents)
            ...
            .map(([date, dayIncidents]) => (<div key={date}>
            ...
            <div className="space-y-4">
              {dayIncidents
                ...
                .map((incident) => (<div key={incident.id} className="card p-6">
                    {/* Incident header */}
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          {incident.resolvedAt && (<span className="text-xs text-gray-500">
                              Resolved {(0, api_1.getRelativeTime)(incident.resolvedAt)}
                            </span>)}
                        </div>
                        ...
                        {/* Affected services */}
                        {incident.affectedServices.length > 0 && (<div className="mb-3">
                        ...
                        <div className="text-sm text-gray-500">
                          <div>
                            Started: {(0, api_1.formatDateTime)(incident.startedAt)}
                          </div>
                          {incident.resolvedAt && (<div>
                              Resolved: {(0, api_1.formatDateTime)(incident.resolvedAt)}
                              <span className="ml-2">
                    ...
                    {/* Incident updates */}
                    {incident.updates.length > 0 && (<div className="border-t border-gray-100 pt-4">
                        ...
                        .map((update) => (<div key={update.id} className="bg-gray-50 rounded-lg p-3">
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <span className="text-xs text-gray-500">
                                    {(0, api_1.formatDateTime)(update.timestamp)}
                                  </span>
                                </div>
...
exports.IncidentsList = IncidentsList;
//# sourceMappingURL=IncidentsList.js.map